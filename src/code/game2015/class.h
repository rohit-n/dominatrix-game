...
template<class T>
inline int operator == (const SafePtr<T> &a, T *b) noexcept
{
   return a.ptr == b;
}
...
template<class T>
inline int operator == (T *a, const SafePtr<T> &b) noexcept
{
   return a == b.ptr;
}
...
template<class T>
inline int operator == (const SafePtr<T> &a, const SafePtr<T> &b) noexcept
{
   return a.ptr == b.ptr;
}
